...
const TeacherSidebar = ({ className }) => {
  ...
  const navigation = [
    { name: "Dashboard", href: "/teacher", icon: "BarChart3", exact: true },
    { name: "Assignments", href: "/teacher", icon: "BookOpen" },
    { name: "Students", href: "/teacher", icon: "Users" },
    { name: "Grades", href: "/teacher", icon: "FileText" },
    { name: "Analytics", href: "/teacher", icon: "TrendingUp" }
  ];
      ...
      <div className="p-6">
        <div className="mb-6">
          <div className="flex items-center space-x-3 p-3 bg-slate-50 rounded-lg">
            ...
            <div>
              <p className="text-sm font-medium text-slate-900">{currentUser?.name || "Teacher"}</p>
