...
return (
    <div className={cn("min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100", className)}>
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-lg font-semibold bg-gradient-to-r from-primary-600 to-sky-500 bg-clip-text text-transparent">
            Loading SafetyHub...
          </p>
          <p className="text-sm text-slate-600">Please wait while we initialize your workspace</p>
        </div>
      </div>
    </div>
  );
